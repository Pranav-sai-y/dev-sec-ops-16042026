...
// *
// * DevSecOps: These tests verify the SECURITY CONTRACT of the application —
// * not just functional correctness. Key scenarios:
// *
// *   1. Unauthenticated requests are rejected (401)
// *   2. Login with valid credentials returns a JWT
// *   3. Login with invalid credentials returns 401 (no detail leakage)
// *   4. Non-ADMIN user cannot access write endpoints (403)
// *   5. Context loads without a hardcoded JWT secret (env var required)
// */
//@SpringBootTest
...
//                   .content("{\"username\":\"hr.admin\",\"password\":\"Admin@SBI123\"}"))
...
//        // management.endpoints.web.exposure.include=health,info ensures it is not mapped
