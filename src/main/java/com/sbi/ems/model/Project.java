 ...
 * A project can have many employees; one employee can work on many projects.
 * The many-to-many is resolved via {@link EmployeeProject}.
 */
@Entity
@Table(
    name = "projects",
...
public class Project {
    ...
    /**
     * One project → Many EmployeeProject assignments.
     * orphanRemoval = true: if an EmployeeProject is removed from this list,
